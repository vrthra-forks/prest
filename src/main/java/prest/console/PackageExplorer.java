...
import prest.common.ArffUtils;
import prest.common.DirectoryListing;
import prest.executor.ParserExecutor;
import prest.common.CsvToArff;
import prest.predictor.WekaRunner;
...
public class PackageExplorer {
	...
	public boolean searchRepository(File newDirectory) {
		prest.common.DirectoryListing dlx = new DirectoryListing();
